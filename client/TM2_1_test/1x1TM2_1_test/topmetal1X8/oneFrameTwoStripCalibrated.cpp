...
char canvas2Dfn[100];
char canvas1Dfn[100];
sprintf(canvas2Dfn,"../result/pd1/dim%d_frame%d-%dCalibrated_file%d.png",dimId, frame1Id, frame2Id, fileId);
sprintf(canvas1Dfn,"../result/pd1/dim%d_projection%d-%dCalibrated_file%d.png",dimId, frame1Id, frame2Id, fileId);
...
for(int i=0; i<nStrip; i++){
	...
	wframe.loadtmpHist2HistCalibrated(ip, chipCalibratedPara, edgeCalibratedPara);
