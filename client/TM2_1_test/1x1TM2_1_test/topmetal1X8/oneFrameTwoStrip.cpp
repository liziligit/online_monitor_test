...
char canvas2Dfn[100];
char canvas1Dfn[100];
sprintf(canvas2Dfn,"../result/pd1/dim%d_frame%d-%d_file%d.png",dimId, frame1Id, frame2Id, fileId);
sprintf(canvas1Dfn,"../result/pd1/dim%d_projection%d-%d_file%d.png",dimId, frame1Id, frame2Id, fileId);
int nStrip=2;
pd1Pede pede[nStrip];
